...
urlpatterns = [    
    ...
    path('it-hardware-and-software-services/',views.uk_main_service,name="uk-main-service"),
    path('vmware-third-party-support/',views.uk_vmware_support,name="uk-vmware-support"),
    path('microsoft-thirdparty-support/',views.uk_microsoft_support,name="uk-microsoft-support"),
